...
for kk = 1:2
    ...
    if ~isfield(pde,'exact') || ~isfield(pde,'rhs')
        ...
        CAC_Vesicle_3D_MSAV_BDF(pde,domain,Nx,Ny,Nz,time,option);
...
%% results:
% epsilon=0.147,t=0.0020/0.002, dt=1.56e-06, Nx=32, Ny=32, Nz=32, timeElapsed=20.873609
% Accuracy test with reference solution. alpha = 1.000000
%     dt     &   Error_L2 & Order 
% 1.0000e-04 & 2.7461e-01 & 0.00 
% 5.0000e-05 & 3.8224e-01 & -0.48 
% 2.5000e-05 & 4.4561e-01 & -0.22 
% 1.2500e-05 & 2.0131e-01 & 1.15 
% 6.2500e-06 & 1.9035e-06 & 16.69 
% 3.1250e-06 & 4.7534e-07 & 2.00 
% 1.5625e-06 & 1.1845e-07 & 2.00 
% 
% epsilon=0.147,t=0.0020/0.002, dt=1.56e-06, Nx=32, Ny=32, Nz=32, timeElapsed=15.630799
% Accuracy test with reference solution. alpha = 1.000000
% Stabilized method
%     dt     &   Error_L2 & Order 
% 1.0000e-04 & 7.4111e-03 & 0.00 
% 5.0000e-05 & 1.8813e-03 & 1.98 
% 2.5000e-05 & 4.8046e-04 & 1.97 
% 1.2500e-05 & 1.2183e-04 & 1.98 
% 6.2500e-06 & 3.0699e-05 & 1.99 
% 3.1250e-06 & 7.7018e-06 & 1.99 
% 1.5625e-06 & 1.9237e-06 & 2.00 
