...
%% results:
% lambda=-3.3147e+01,eta=1.0000e+00,epsilon=0.147,t=0.00200/0.0020, dt=1.56e-06, Nx=32, Ny=32, timeElapsed=14.771071
% Accuracy test with reference solution.
%     dt     &   Error_L2   & Order 
% 1.0000e-04 & 1.6762e-03 & 0.00 
% 5.0000e-05 & 8.6088e-04 & 0.96 
% 2.5000e-05 & 4.3572e-04 & 0.98 
% 1.2500e-05 & 2.1855e-04 & 1.00 
% 6.2500e-06 & 1.0861e-04 & 1.01 
% 3.1250e-06 & 5.3521e-05 & 1.02 
% 1.5625e-06 & 2.5899e-05 & 1.05

% Stabilized
% lambda=-3.3149e+01,eta=1.0000e+00,epsilon=0.147,t=0.00200/0.0020, dt=1.56e-06, Nx=32, Ny=32, timeElapsed=12.440674
% Accuracy test with reference solution.
%     dt     &   Error_L2   & Order 
% 1.0000e-04 & 1.1802e-02 & 0.00 
% 5.0000e-05 & 7.2985e-03 & 0.69 
% 2.5000e-05 & 4.1335e-03 & 0.82 
