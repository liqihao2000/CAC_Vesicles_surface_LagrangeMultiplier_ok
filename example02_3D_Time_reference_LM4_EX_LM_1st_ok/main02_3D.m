...
%         CAC_Vesicle_3D_LM3_LM_1st(pde,domain,Nx,Ny,Nz,time,option);
        CAC_Vesicle_3D_LM4_EX_LM_1st(pde,domain,Nx,Ny,Nz,time,option);
    end
    for k = 1:maxIt
        dt = dt_array(k);
...
%% results:
% xi=-3.3197e+01,eta=1.0000e+00,epsilon=0.147,t=0.00200/0.0020, dt=1.56e-06, Nx=32, Ny=32, Nz=32, timeElapsed=86.586619
% Accuracy test with reference solution. alpha = 1.000000
%     dt     &   Error_L2 & Order 
% 1.0000e-04 & 6.6202e-04 & 0.00 
% 5.0000e-05 & 3.4034e-04 & 0.96 
...
% 
% xi=-3.3197e+01,eta=1.0000e+00,epsilon=0.147,t=0.00200/0.0020, dt=1.56e-06, Nx=32, Ny=32, Nz=32, timeElapsed=92.302547
% Accuracy test with reference solution. alpha = 1.000000
% Stabilized method
%     dt     &   Error_L2 & Order 
% 1.0000e-04 & 4.4587e-03 & 0.00 
% 5.0000e-05 & 2.7548e-03 & 0.69 
...
% xi=-3.3197e+01,eta=1.0000e+00,epsilon=0.147,t=0.00200/0.0020, dt=1.56e-06, Nx=32, Ny=32, Nz=32, timeElapsed=100.659126
...
% 1.5625e-06 & 1.0266e-05 & 1.05 
% 
% xi=-3.3197e+01,eta=1.0000e+00,epsilon=0.147,t=0.00200/0.0020, dt=1.56e-06, Nx=32, Ny=32, Nz=32, timeElapsed=103.004259
% Accuracy test with reference solution. alpha = 0.100000
% Stabilized method
%     dt     &   Error_L2 & Order 
% 1.0000e-04 & 4.4587e-03 & 0.00 
...
% xi=-3.3197e+01,eta=1.0000e+00,epsilon=0.147,t=0.00200/0.0020, dt=1.56e-06, Nx=32, Ny=32, Nz=32, timeElapsed=103.446388
...
% xi=-3.3197e+01,eta=1.0000e+00,epsilon=0.147,t=0.00200/0.0020, dt=1.56e-06, Nx=32, Ny=32, Nz=32, timeElapsed=83.155719
% Accuracy test with reference solution. alpha = 0.000100
% Stabilized method
%     dt     &   Error_L2 & Order 
% 1.0000e-04 & 4.4587e-03 & 0.00 
