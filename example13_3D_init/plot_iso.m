...
%     subplot(1,2,1)
    ...
    set(p0,'FaceColor','#0072BD', 'EdgeColor','none');
%     set(p0,'FaceColor','#D95319', 'EdgeColor','none');
%     set(p0,'FaceColor','#EDB120', 'EdgeColor','none');
%     set(p0,'FaceColor','#7E2F8E', 'EdgeColor','none');
%     set(p0,'FaceColor','#77AC30', 'EdgeColor','none');
%     set(p0,'FaceColor','#4DBEEE', 'EdgeColor','none');
%     set(p0,'FaceColor','#A2142F', 'EdgeColor','none');
%     set(p0,'FaceColor','b', 'EdgeColor','none');
...
%     zlabel('$z$','FontSize',18,'Interpreter','LaTex');
    ...
    figname = ['/Users/liq/research/papers/paper15_Vesicles/01_CAC_LagrangeMultiplier/paper_Vesicle_00_Lagrange_CAC/figure_Vesicle_00_Lagrange_CAC/' dirname '_phi_t=' num2str(t) '.png']
