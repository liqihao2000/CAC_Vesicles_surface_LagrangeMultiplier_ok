...
for kk = 1:2
    ...
    if ~isfield(pde,'exact') || ~isfield(pde,'rhs')
        ...
        CAC_Vesicle_3D_MSAV_1st(pde,domain,Nx,Ny,Nz,time,option);
...
%% results:
% epsilon=0.147,t=0.0020/0.002, dt=1.56e-06, Nx=32, Ny=32, Nz=32, timeElapsed=13.635110
% Accuracy test with reference solution. alpha = 1.000000
%     dt     &   Error_L2 & Order 
% 1.0000e-04 & 2.0617e-01 & 0.00 
% 5.0000e-05 & 2.8790e-01 & -0.48 
% 2.5000e-05 & 2.2779e-01 & 0.34 
% 1.2500e-05 & 6.2040e-04 & 8.52 
% 6.2500e-06 & 3.0764e-04 & 1.01 
% 3.1250e-06 & 1.5131e-04 & 1.02 
% 1.5625e-06 & 7.3150e-05 & 1.05

% epsilon=0.147,t=0.0020/0.002, dt=1.56e-06, Nx=32, Ny=32, Nz=32, timeElapsed=15.281107
% Accuracy test with reference solution. alpha = 1.000000
% Stabilized method
%     dt     &   Error_L2 & Order 
% 1.0000e-04 & 1.4674e-01 & 0.00 
% 5.0000e-05 & 8.0632e-02 & 0.86 
% 2.5000e-05 & 4.2329e-02 & 0.93 
% 1.2500e-05 & 2.1639e-02 & 0.97 
% 6.2500e-06 & 1.0876e-02 & 0.99 
% 3.1250e-06 & 5.3853e-03 & 1.01 
% 1.5625e-06 & 2.6124e-03 & 1.04 
