function [phi,eta,lambda] = CAC_Vesicle_3D_LM3_LM_1st(pde,domain,Nx,Ny,Nz,time,option)
...
%         tmp  = ephi_t./M - lap_diff(emu);
    ...
    eta_initial = 1; 
    eta = fsolve(@(eta)non_fun_eta(eta,lambda,phi1_new,phi2_new,phi3_new,phi0),eta_initial,opts);
