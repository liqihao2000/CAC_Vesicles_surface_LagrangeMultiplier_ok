...
%% results:
% lambda=-3.3147e+01,eta=1.0000e+00,epsilon=0.147,t=0.00200/0.0020, dt=1.56e-06, Nx=32, Ny=32, timeElapsed=7.903701
% Accuracy test with reference solution.
%     dt     &   Error_L2   & Order 
% 1.0000e-04 & 1.4611e-04 & 0.00 
% 5.0000e-05 & 3.7082e-05 & 1.98 
% 2.5000e-05 & 9.3387e-06 & 1.99 
% 1.2500e-05 & 2.3431e-06 & 1.99 
% 6.2500e-06 & 5.8710e-07 & 2.00 
% 3.1250e-06 & 1.4679e-07 & 2.00 
% 1.5625e-06 & 3.6601e-08 & 2.00 

% Stabilized
% lambda=-3.3147e+01,eta=1.0000e+00,epsilon=0.147,t=0.00200/0.0020, dt=1.56e-06, Nx=32, Ny=32, timeElapsed=6.503983
% Accuracy test with reference solution.
%     dt     &   Error_L2   & Order 
% 1.0000e-04 & 1.4120e-03 & 0.00 
% 5.0000e-05 & 3.7663e-04 & 1.91 
% 2.5000e-05 & 9.7666e-05 & 1.95 
% 1.2500e-05 & 2.4910e-05 & 1.97 
