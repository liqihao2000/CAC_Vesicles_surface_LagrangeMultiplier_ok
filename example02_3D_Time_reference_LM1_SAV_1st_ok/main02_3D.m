...
% lambda=-3.3197e+01,epsilon=0.147,t=0.00200/0.0020, dt=1.56e-06, Nx=32, Ny=32, Nz=32, timeElapsed=80.023751
% Accuracy test with reference solution.
%     dt     &   Error_L2 & Order 
...
% Stabilized 
% Accuracy test with reference solution.
% lambda=-3.3197e+01,epsilon=0.147,t=0.00200/0.0020, dt=1.56e-06, Nx=32, Ny=32, Nz=32, timeElapsed=81.076075
% Accuracy test with reference solution.
%     dt     &   Error_L2 & Order 
